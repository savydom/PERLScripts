...
open (MISC,">/home/scriptid/scripts/BACKUPS/VMware60/MiscRemoveSnapshot.bat") || die "Could not open /home/scriptid/scripts/BACKUPS/VMware60/MiscRemoveSnapshot.bat\n";
(@return) = `/usr/bin/cat /home/scriptid/scripts/BACKUPS/VMware60/RVTools_tabvSnapshot.csv`;
#$i = 1;
foreach $val (@return) {
...
foreach $val (sort keys %misc_delete) {
   ...
   print MISC "$prefix testsnapshot.exe -H pvnocsavc01 -u cdc\\vadp -p 1qaz2wsx\!QAZ\@WSX -l vm-name -k $val -c delete -n _NETWORKER-VADP-BACKUP_\r\n";
}
print MISC "exit\n";
close MISC;
$return = `/bin/chmod 755 /home/scriptid/scripts/BACKUPS/VMware60/MiscRemoveSnapshot.bat`;
